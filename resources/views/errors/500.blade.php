...
<div id="app" class="app">
    <div class="lv-container">
        <div class="error">
            <div id="header">
                <a id="logo" href="/">
                    <img src="/images/favicon.png" alt="LvBlog logo">
                    <span>LvBlog</span>
                </a>
                <ul id="nav">
                    <li>
                        <a href="/" class="nav-link contribute"><i class="el-icon-s-home"></i>首页</a>
                    </li>
                </ul>
            </div>
            <div id="hero">
                <div class="inner">
                    <div class="left">
                        ...
                        <h2 class="vue">Lv.Blog</h2>
                        <h1>
                            500<br>服务器端错误,请联系管理员.
                        </h1>
                        <p>
                            <a id="modal-player" class="button has-icon" href="{{env('APP_URL')}}">
                            ...
                            <a class="button gray has-icon" href="https://gitee.com/bluish_space/lvblog" target="_blank">
                                <img style="height:25px;float: left" src="/images/mayun.png">码云
                            </a>
                        </p>
                    </div>
                </div>
            ...
            <div id="special-sponsor">
                ...
                <a href="#" target="_blank">
                    <img src="https://mozilan.geekadpt.cn/img/custom/donate/AliPayQR.jpg" style="width:200px">
                </a>
                <a href="#" target="_blank">
                    <img src="https://mozilan.geekadpt.cn/img/custom/donate/WeChanSQ.jpg" style="width:200px">
                </a>
            </div>
            <div id="highlights">
                <div class="inner">
